 ...
 */
var existed = typeof self.MVC !== "undefined"; // export once onto global namespace

var MVC    = module.exports = self.MVC = ( self.MVC || {} );
var Pubsub = MVC.Pubsub     = ( self.MVC.Pubsub || require( "pubsub-js" ));
